...
define( '{%= prefix_caps %}_VERSION', '0.1.0' );
 ...
 function {%= prefix %}_scripts_styles() {
  ...
  wp_enqueue_script( '{%= prefix %}', get_template_directory_uri() . "/assets/js/vendor/custom.modernizr.js", array(), {%= prefix_caps %}_VERSION, true );
  wp_enqueue_script( '{%= prefix %}', get_template_directory_uri() . "/assets/js/foundation/foundation.js", array(), {%= prefix_caps %}_VERSION, true );
    
  wp_enqueue_style( '{%= prefix %}', get_template_directory_uri() . "/assets/css/src/{%= js_safe_name %}.css", array(), {%= prefix_caps %}_VERSION );
 }
